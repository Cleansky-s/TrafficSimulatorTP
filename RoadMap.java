...
public class RoadMap {
	...
	void addRoad(Road r) {
		if(!this.roadMap.containsKey(r.getId())) { // Falta una condicion: los cruces de la carretera existen en el mapa de carreteras
			roadList.add(r);
	...
	void addVehicle(Vehicle v) {
		if(!this.vehicleMap.containsKey(v.getId())) { // FALTA condiciones
		vehicleList.add(v);
